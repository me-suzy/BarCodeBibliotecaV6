-- Script rapid pentru crearea tabelului statute_cititori și coloanei statut
-- Rulează în phpMyAdmin sau MySQL
...
-- ============================================
-- PASUL 2: Inserează statutele predefinite
-- ============================================
...
-- Pentru cititorii cu coduri care nu respectă formatul, păstrează statutul implicit '14'
UPDATE cititori 
SET statut = '14'
